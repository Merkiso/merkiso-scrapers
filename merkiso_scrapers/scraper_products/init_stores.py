...
def create_stores():
    ...
    data_list = [
        {
            "name": "Euro",
            "url": "https://www.eurosupermercados.com.co",
            "domain": "www.eurosupermercados.com.co",
        ...
        {
            "name": "Metro",
            "url": "https://www.tiendasmetro.co",
            "domain": "www.tiendasmetro.co",
            "checkout_prefix": "/checkout",
        },
    ]
    stores_collection = db_connection.get_collection(
        db_name="merkiso_db", collection_name="stores"
    )
    ...
    for doc in data_list:
        ...
        store = db_connection.find_one(
            db_name="merkiso_db", collection_name="stores", query={"url": doc["url"]}
        )
        ...
        db_connection.insert_one(
            db_name="merkiso_db", collection_name="stores", data=doc
        )
